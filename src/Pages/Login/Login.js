                                ...
                                <div className="col-md-6 p-5">
                                    ...
                                    <form className="py-4">
                                        <div className="input-group mb-3">
                                            <span className="input-group-text rounded-start-1" id="basic-addon1">
                                                <FaUser />
                                            </span>
                                            <input
                                                type="text"
                                        ...
                                        <div className="input-group mb-3">
                                            <span className="input-group-text rounded-start-1" id="basic-addon2">
                                                <FaLock />
                                            </span>
                                            <input
                                                type="password"
                                        ...
                                        <div className="text-end">
                                            <Link to="#" className="text-decoration-none text-primary fw-semibold">Forget Password?</Link>
                                        </div>
                                        <div className="text-end mt-3">
                                            <Link to="/StaffDashboard" className="btn btn-primary px-3 py-2 fw-semibold text-capitalize">
                                                <FaUserLock /> &nbsp; Login
                                            </Link>
                                        </div>
                                    </form>
