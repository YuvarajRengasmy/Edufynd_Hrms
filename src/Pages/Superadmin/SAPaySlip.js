...
export const SAPaySlip = () => {
  ...
  <div className="col-md-6">
    <h5 style={{ color: '#7627ef' }}>Employee Pay Summary</h5>
    <div className="row">
      ...
      <div className="col-6 mb-1"><strong><i class="fas fa-calendar-check "></i>&nbsp;&nbsp;Date Of Joining</strong></div>
      <div className="col-6 mb-1">:  15-04-2024</div>
      
      <div className="col-6 mb-1"><strong><i class="fas fa-calendar-alt "></i>&nbsp;&nbsp;Pay Period</strong></div>
      <div className="col-6 mb-1">:  August, 2024</div>
      
      <div className="col-6 mb-1"><strong><i class="fas fa-calendar-day "></i>&nbsp;&nbsp;Pay Date</strong></div>
      <div className="col-6 mb-1">:  05-09-2024</div>
    </div>
  </div>
  <div className="col-md-6">
    <h6 className="text-center">Employee Net Pay</h6>
    <h2 className="mb-1 text-center fw-bold" style={{ color: '#28A745' }}>&#8377;45,000.00</h2>
    <p className="mb-1 text-center fw-normal"><strong>Pay Days: 30 Days | LOP Days: 0 Days</strong></p>
  </div>
</div>
