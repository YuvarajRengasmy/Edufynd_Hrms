   ...
   <ol class="breadcrumb">
     ...
     <div className="card border-0 p-2">
         <div className="card-header border-0 bg-white">
             ...
             <Link to='/SAAddEmployees' className="btn btn-sm text-white text-capitalize  float-end fw-semibold" style={{backgroundColor:'#7267ef'}}>Add Employees</Link>
         </div>
                 ...
                 <tbody style={{ fontSize: '11px' }}>
                     <tr>
                         ...
                         <td>
                                  ...
                                  data-bs-toggle="modal" data-bs-target="#employeesModaldelete"
     ...
     <div class="modal fade" id="employeesModaldelete" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
