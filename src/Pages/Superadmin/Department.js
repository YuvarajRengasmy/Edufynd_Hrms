...
const Department = () => {
    return (
        <>
                                        ...
                                        <form>
                                            <div className="card-body">
                                                <div className="mb-3">
                                                    ...
                                                    <input type="text" className="form-control rounded-1" placeholder="Example James Lee" style={{ fontSize: '12px' }} />
                                                </div>
                                                <div className="mb-3">
            ...
            <div className="modal fade" id="departmentModaldelete" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div className="modal-dialog">
        <div className="modal-content">
            <div className="modal-header">
                <h1 className="modal-title fs-6" id="exampleModalLabel">Are you sure you want to delete this record?</h1>
            ...
            <div className="modal-footer">
                <button type="button" className="btn btn-light border-0 rounded-1" data-bs-dismiss="modal" style={{ fontSize: '13px' }}>Close</button>
                <button type="button" className="btn border-0 rounded-1" style={{ backgroundColor: '#7267ef', color: '#fff', fontSize: '13px' }}>Confirm</button>
            </div>
        </div>
    </div>
</div>

<div className="modal fade" id="departmentModaledit" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div className="modal-dialog">
        <div className="modal-content">
            <div className="modal-header">
                <h1 className="modal-title fs-5" id="exampleModalLabel">Edit Department Information</h1>
            ...
            <div className="modal-footer">
                <button type="button" className="btn btn-light border-0 rounded-1" data-bs-dismiss="modal" style={{ fontSize: '13px' }}>Close</button>
                <button type="button" className="btn border-0 rounded-1" style={{ backgroundColor: '#7267ef', color: '#fff', fontSize: '13px' }}>Update</button>
            </div>
        </div>
    </div>
</div>
