                ...
                <div className="col-lg-6 mb-3">
                  ...
                  <div className="d-flex justify-content-around align-items-center gap-5">
                    ...
                    <div className="col my-3">
                      <div className="card card-body border-0" style={{ backgroundColor: '#7267ef', color: '#fff' }}>
                        <h6 className="card-title mb-2 fw-normal">Travel Request</h6>
                        <div className="d-flex justify-content-between align-items-center">
                          <h3 className="card-title mb-0">0</h3>
                        </div>
                      </div>
                  ...
                  <div className="col-md-12 mb-3">
                    <div className="card border-0">
                      <div className="card-header bg-white p-3 fw-semibold">Tasks Status</div>
                      <div className="card-body p-3">
                        <ResponsiveContainer width="100%" height={200}>
                          <LineChart data={salesData}>
                            ...
                            <Tooltip />
                            <Legend />
                            <Line type="monotone" dataKey="sales" stroke="#7267ef" />
                          </LineChart>
                        </ResponsiveContainer>
                        <div className="mt-3 d-flex flex-wrap">
                          {salesData.map((item) => (
                            <p key={item.month} className="me-3">{item.month}: {item.sales}</p>
                          ))}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="d-flex justify-content-around align-items-center">
                    ...
                    <div className="col-5 my-3">
                      <div className="card card-body border-0" style={{ backgroundColor: '#7267ef', color: '#fff' }}>
                        <h6 className="card-title mb-2 fw-normal">Total Assets</h6>
                        <div className="d-flex justify-content-between align-items-center">
                          <h3 className="card-title mb-0">0</h3>
                        </div>
                      </div>
                  ...
                  <div className="col-md-12 mb-3">
                    <div className="card border-0">
                      <div className="card-header bg-white p-3 fw-semibold">Ticket Priority</div>
                      <div className="card-body p-3">
                        <ResponsiveContainer width="100%" height={200}>
                        ...
                        <div className="mt-3 d-flex flex-wrap">
                          {revenueData.map((item) => (
                            <p key={item.day} className="me-3">{item.day}: {item.revenue}</p>
                          ))}
                        </div>
                      </div>
                    </div>
                ...
                <div className="col-lg-6 mb-3">
                  <div className="d-flex justify-content-around align-items-center">
                    <div className="col-5 mb-4">
                      <div className="card card-body border-0" style={{ backgroundColor: '#17c666', color: '#fff' }}>
                        <h6 className="card-title mb-2 fw-normal">Expense Claim</h6>
                        <div className="d-flex justify-content-between align-items-center">
                  ...
                  <div className="col-12 mb-3">
                    <div className="card border-0">
                      <div className="card-header bg-white p-3 fw-semibold">Task Completion</div>
                      <div className="card-body p-3">
                        <ResponsiveContainer width="100%" height={200}>
                          <AreaChart data={taskCompletionData}>
                            ...
                            <Tooltip />
                            <Legend />
                            <Area type="monotone" dataKey="completion" stroke="#7267ef" fill="#7267ef" />
                          </AreaChart>
                        </ResponsiveContainer>
                        <div className="mt-3 d-flex flex-wrap">
                          {taskCompletionData.map((item) => (
                            <p key={item.task} className="me-3">{item.task}: {item.completion}%</p>
                          ))}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="col-12 mb-3">
                    <div className="card border-0">
                      <div className="card-header bg-white p-3 fw-semibold">Project Status</div>
                      <div className="card-body p-3">
                        <ResponsiveContainer width="100%" height={200}>
                          <PieChart>
                            <Pie data={taskStatusData} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={80} fill="#7267ef">
